...
// Los guards de auth/CSRF/throttling se reutilizan en resolvers GraphQL y en el
// controller REST de subida de archivos: cada tipo de contexto guarda el
// Request/Response en un lugar distinto, así que hay que resolverlo según de
